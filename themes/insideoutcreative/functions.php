...
function morganbirge_stylesheets() {
...
add_action('wp_enqueue_scripts', 'morganbirge_stylesheets');
// for footer
function morganbirge_stylesheets_footer() {
...
add_action('get_footer', 'morganbirge_stylesheets_footer');
...
add_action('after_setup_theme', 'morganbirge_menus');
